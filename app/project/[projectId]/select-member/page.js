...
export default function SelectMemberPage() {
  ...
  function chooseMember([initials, name, role, color]) {
    selectProjectMember({ initials, name, role, color });
