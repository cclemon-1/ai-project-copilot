...
import { members, project } from "@/data/mockData";
...
export default function WorkspacePage() {
  ...
  function createProject(event) {
    ...
    setCreating(false);
    setMessage("Project created with a shared Project PIN. Connect a backend when you are ready to persist it.");
    setNewPin("");
    setConfirmPin("");
    setPinError("");
  }
