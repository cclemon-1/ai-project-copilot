...
export default function DashboardClient() {
  ...
  const calendarUrl = "https://calendar.google.com/calendar/render?action=TEMPLATE&text=" + encodeURIComponent(meeting.title) + "&dates=20260724T020000Z/20260724T030000Z&details=" + encodeURIComponent(meeting.summary) + "&location=" + encodeURIComponent(meeting.link);
  ...
  function downloadMeeting() {
    const content = ["BEGIN:VCALENDAR", "VERSION:2.0", "BEGIN:VEVENT", "DTSTART:20260724T020000Z", "DTEND:20260724T030000Z", "SUMMARY:" + meeting.title, "DESCRIPTION:" + meeting.summary, "LOCATION:" + meeting.link, "END:VEVENT", "END:VCALENDAR"].join("\r\n");
